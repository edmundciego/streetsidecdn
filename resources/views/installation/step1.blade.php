                    ...
                    <div class="row g-4 g-md-5">
                        ...
                        @foreach($permission as $key => $item)
                            @if ($key != 'db_file_write_perm' && $key != 'routes_file_write_perm')
                                <div class="col-md-6">
                                    <div class="d-flex gap-3 align-items-center">
                                        <img src="{{ image_asset('public/assets/installation') }}/assets/img/svg-icons/curl-enabled.svg" alt="">
                            ...
                            <img src="{{ image_asset('public/assets/installation') }}/assets/img/svg-icons/info.svg"
                                 class="svg text-danger" alt="">
                        </span>
                                            @endif
                                        </div>
