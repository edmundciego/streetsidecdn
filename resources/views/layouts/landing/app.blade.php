                    ...
                    <div class="footer-widget">
                            ...
                            @if (isset($social_media))
                                ...
                                <li>
                                    <a href="{{ $social->link }}" target="_blank">
                                        <img src="{{ image_asset('public/assets/landing/img/footer/'. $social->name.'.svg') }}" alt="">
                                    </a>
                                </li>
                                @endforeach
                            @endif
                        ...
                        <div class="app-btn-grp">
                            ...
                            <a href="{{ isset($landing_page_links['playstore_url']) ? $landing_page_links['playstore_url'] : '' }}">
                                <img src="{{ image_asset('public/assets/landing/img/google.svg') }}" alt="">
                            </a>
                            @endif
                            ...
                            <a href="{{ isset($landing_page_links['apple_store_url']) ? $landing_page_links['apple_store_url'] : '' }}">
                                <img src="{{ image_asset('public/assets/landing/img/apple.svg') }}" alt="">
                            </a>
                            @endif
                        </div>
                        @endif
