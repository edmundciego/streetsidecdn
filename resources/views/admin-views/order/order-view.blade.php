                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">
                        <span class="page-header-icon">
                            <img src="{{ image_asset('/public/assets/admin/img/shopping-basket.png') }}" class="w--20"
                                alt="">
                        </span>
                        <span>
                            ...
                            <div class="text-right mt-3 order-invoice-right-contents text-capitalize">
                                ...
                                @if ($order->order_attachment)
                                                ...
                                                <div>
                                                    <button class="btn w-100 px-0" data-toggle="modal"
                                                        ...
                                                        <div class="gallary-card ml-auto">
                                                            <img src="{{ image_asset('storage/app/' . 'public/order/' . $item) }}"
                                    ...
                                    <button class="btn w-100 px-0" data-toggle="modal" data-target="#imagemodal"
                                        title="{{ translate('messages.order_attachment') }}">
                                        <div class="gallary-card ml-auto">
                                            <img src="{{ image_asset('storage/app/' . 'public/order/' . $order->order_attachment) }}"
                                                alt="{{ translate('messages.prescription') }}"
                                                class="initial--22 object-cover">
                                        </div>
                                    </button>
                                            ...
                                            <div class="modal fade" id="imagemodal{{ $key }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img src="{{ image_asset('storage/app/' . 'public/refund/' . $img) }}"
                                                                class="initial--22 w-100">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <a class="btn btn-primary"
                                    ...
                                    <div class="modal fade" id="imagemodal{{ $key }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img src="{{ image_asset('storage/app/' . 'public/order/' . $img) }}"
                                                        class="initial--22 w-100">
                                                </div>
                                                <div class="modal-footer">
                                                    <a class="btn btn-primary"
