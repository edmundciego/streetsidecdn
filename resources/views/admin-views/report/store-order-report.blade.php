...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header report-page-header">
            <div class="d-flex">
                <img src="{{ image_asset('public/assets/admin/img/store-report.svg') }}" class="page-header-icon" alt="">
        ...
        <div class="store-report-content mt-11px">
            <div class="left-content">
                <div class="left-content-card">
                    <img src="{{ image_asset('/public/assets/admin/img/report/cart.svg') }}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{ image_asset('/public/assets/admin/img/report/total-order.svg') }}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{ image_asset('/public/assets/admin/img/report/total-discount.svg') }}" alt="">
                    <div class="info">
                        <h4 class="subtitle">
