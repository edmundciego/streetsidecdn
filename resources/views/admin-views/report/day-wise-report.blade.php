        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{ image_asset('public/assets/admin/img/report.png') }}" class="w--22" alt="">
                </span>
                <span>
                    ...
                    <div class="row g-2">
                        <div class="col-sm-6">
                            ...
                            <a class="__card-3 h-100" href="#">
                                <img src="{{ image_asset('/public/assets/admin/img/report/new/trx1.png') }}" class="icon"
                                    alt="report/new">
                                ...
                                <div class="info-icon" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <img src="{{ image_asset('/public/assets/admin/img/report/new/info1.png') }}"
                                        alt="report/new">
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-6">
                            ...
                            @endphp
                            <a class="__card-3 h-100" href="#">
                                <img src="{{ image_asset('/public/assets/admin/img/report/new/trx3.png') }}" class="icon"
                                    alt="report/new">
                                ...
                                <div class="info-icon" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <img src="{{ image_asset('/public/assets/admin/img/report/new/info3.png') }}"
                                        alt="report/new">
                                </div>
                            </a>
                        </div>
                            ...
                            <div class="__card-vertical">
                                <div class="__card-vertical-img">
                                    ...
                                    <div class="info-icon" data-toggle="tooltip" data-placement="right"
                                        ...
                                        <img src="{{ image_asset('/public/assets/admin/img/report/new/info2.png') }}"
                                            alt="report/new">
                                    </div>
                                </div>
        ...
        <div class="card mt-3">
            ...
            @if (count($order_transactions) === 0)
                <div class="empty--data">
                    <img src="{{ image_asset('/public/assets/admin/svg/illustrations/sorry.svg') }}" alt="public">
                    <h5>
