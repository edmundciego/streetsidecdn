            ...
            <div class="d-flex flex-wrap justify-content-between align-items-start gap-2">
                <div class="d-flex gap-2">
                    <div class="page-header-icon">
                        <img src="{{ image_asset('public/assets/admin/img/delivery-man.png') }}" class="w--26" alt="">
                    </div>
                    <div>
...
@endif
                ...
                <div class="d-flex gap-2 align-items-center mt-5">
                    <img src="{{ image_asset('public/assets/admin/img/entypo_image-inverted.png') }}" width="20" height="20"
                        alt="">
                        @if ($deliveryMan->application_status == 'approved')
