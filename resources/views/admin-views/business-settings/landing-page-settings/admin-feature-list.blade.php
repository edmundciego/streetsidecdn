            ...
            <div class="d-flex flex-wrap justify-content-between">
                <h1 class="page-header-title">
                    <span class="page-header-icon">
                        <img src="{{ image_asset('public/assets/admin/img/landing.png') }}" class="w--20" alt="">
                    </span>
                    <span>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="feature_title" class="form-label">{{ translate('Title') }}
                                            ({{ translate('messages.default') }})<span class="form-label-secondary"
                                                ...
                                                <img src="{{ image_asset('public/assets/admin/img/info-circle.svg') }}"
                                                    alt="">
                                            </span></label>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="upload-img-3 m-0">
                                        <div class="img">
                                            <img src="{{ image_asset('/public/assets/admin/img/aspect-1.png') }}"
